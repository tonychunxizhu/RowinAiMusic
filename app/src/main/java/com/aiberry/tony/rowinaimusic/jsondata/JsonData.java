...
public class JsonData
{
    ...
    final String TAG ="AIMUSIC-JsonData";
    int creditLeft=0;
    //String []idFromGen;
...
//    List<String> statusFromGen = new ArrayList<>();
    ...
    private native  String nativeGetCreditLeft();
    public int getCredit(){
        try {
            String jsonString  = nativeGetCreditLeft();//= "{\"credits_left\":40,\"period\":null,\"monthly_limit\":50,\"monthly_usage\":0}";//nativeGetCreditLeft();
            if(jsonString.equals("")){
                Log.d(TAG, "get credit return error ");
                return 0;
            }
            ...
            Log.d(TAG,"Credits Left: " + usageData.getCreditsLeft());
